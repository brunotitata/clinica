...
import br.com.clinica.model.EnviarEmail;
import br.com.clinica.model.EnviarSms;
...
public class PacienteService {
    ...
    public Paciente salvarPaciente(Paciente paciente) {
        ...
        Paciente novoPaciente = new Paciente(new PacienteId(Utils.gerarUUID()),
                paciente.getNome(), paciente.getSexo(), paciente.getRaca(),
                paciente.getDataDeNascimento(), paciente.getCpf(),
                paciente.getRg(), paciente.getCartaoNacionalDeSaude(),
                paciente.getCep(), paciente.getEndereco(), paciente.getBairro(),
                paciente.getCidade(), paciente.getTelefone(), EnviarSms.NAO,
                EnviarEmail.SIM);
    ...
    public Paciente buscarPacientePeloPacienteId(String id) {
        ...
        return pacienteRepository.findByPacienteId(new PacienteId(id))
                .orElseThrow(() -> new IllegalArgumentException(
                        "Não foi possivel encontrar paciente com o ID: " + id));
    }
    ...
    public void excluirPaciente(Long id) {
        ...
        pacienteRepository.delete(pacienteRepository.findById(id)
                .orElseThrow(() -> new IllegalArgumentException(
                        "Não foi possivel deletar paciente com codigo: "
                                + id)));
    }
    ...
    public Paciente alterarPaciente(Long id, Paciente obj) {
        ...
        Paciente paciente = pacienteRepository.findById(id)
                .orElseThrow(() -> new IllegalArgumentException(
                        "Não foi possivel encontrar paciente com o codigo: "
                                + id));
    ...
    public Paciente buscarPacientePorCpf(String cpf) {
        ...
        return pacienteRepository.findByCpf(cpf)
                .orElseThrow(() -> new IllegalArgumentException(
                        "Não foi possivel encontrar paciente com o CPF: "
                                + cpf));
    }
